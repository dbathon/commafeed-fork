...
public class WicketUtils {
  ...
  public static void loadJS(IHeaderResponse response, Class<?> klass, String fileName) {
    final HeaderItem result =
        JavaScriptHeaderItem.forReference(new JavaScriptResourceReference(klass, fileName + ".js"));
  ...
  public static void loadJS(IHeaderResponse response, Class<?> klass, String fileName,
    ...
    try {
      ...
      final String script = template.asString(variables);
