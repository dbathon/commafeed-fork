...
public class Entry implements Serializable {
  ...
  public static Entry build(FeedEntryStatus status, String publicUrl, boolean proxyImages) {
    ...
    final FeedEntry feedEntry = status.getEntry();
    final FeedSubscription sub = status.getSubscription();
    ...
    entry.setContent(FeedUtils.proxyImages(feedEntry.getContent().getContent(), publicUrl,
        proxyImages));
  ...
  public SyndEntry asRss() {
    ...
    final SyndContentImpl content = new SyndContentImpl();
