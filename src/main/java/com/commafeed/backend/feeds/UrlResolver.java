...
public final class UrlResolver {
   ...
   * href="http://www.faqs.org/rfcs/rfc1808.html">RFC1808</a>: Section 2.4: Parsing a URL An
   * accepted method for parsing URLs is useful to clarify the generic-RL syntax of Section 2.2 and
   * to describe the algorithm for resolving relative URLs presented in Section 4. This section
   * describes the parsing rules for breaking down a URL (relative or absolute) into the component
   * parts described in Section 2.1. The rules assume that the URL has already been separated from
   ...
   * href="http://www.faqs.org/rfcs/rfc1808.html">RFC1808</a>: Section 4: Resolving Relative URLs
